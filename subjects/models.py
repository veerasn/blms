...
class Patient(models.Model):
    person = models.ForeignKey(Person, related_name='patients', on_delete=models.CASCADE)
    organization = models.ForeignKey(Organization, related_name='organization_patients', on_delete=models.CASCADE, null=True)
